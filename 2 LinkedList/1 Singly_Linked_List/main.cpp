...
int main()
{
    ...
    while (true)
    {
        std::cout << "1. insert at end";                         //O(1)
        std::cout << "\t2. insert at starting";                  //O(1)
        std::cout << "\t3. insert at possession" << std::endl;   //O(n)
        std::cout << "4. delete from end";                       //O(n)
        std::cout << "\t5. delete from start";                   //O(1)
        std::cout << "\t6. delete from possession" << std::endl; //O(n)
        std::cout << "7. display all values";                    //O(n)
        std::cout << "\t8. display index value" << std::endl;    //O(n)
